...
MATLAB -v 9.16 matlab -nodisplay -nodesktop -r "reconstruction('$rawdata','$outdir','/data/pt_02262/bids_test/loraks_test/loraks_scripts/loraksConfig.json');exit" -sd /data/u_kuegler_software/git/image-reconstruction
