...
MATLAB -v 9.16 matlab -nodisplay -nodesktop -r "reconstruction('$rawdata','$outdir','/data/u_kuegler_software/git/loraks_reconstruction/ironsleep_TH/loraksConfig.json');exit" -sd /data/u_kuegler_software/git/image-reconstruction
