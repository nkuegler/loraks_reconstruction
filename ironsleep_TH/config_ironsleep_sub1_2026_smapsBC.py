...
name_storage_dir = "nii_loraks_recon_smapsBC"   # name of the directory in the output_parent where the reconstructed data will be stored
...
pdw_raw = [[  # 40851.ff
              "meas_MeasUID43_smaps_kp_mtflash3d_v1s_body_260113_130628.dat",    # 20260113
           ], 
        ]

t1w_raw = [[  # 40851.ff
              "meas_MeasUID40_smaps_kp_mtflash3d_v1s_body_260113_130628.dat",    # 20260113
           ], 
        ]

mtw_raw = [[   # 40851.ff
               "meas_MeasUID46_smaps_kp_mtflash3d_v1s_body_260113_130628.dat",    # 20260113
           ], 
        ]
