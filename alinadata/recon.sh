...
#SBATCH -o /data/tu_kuegler/loraks_scripts/logs/alinadata/%j.out	# redirect the output
#
...
MATLAB matlab -nodisplay -nodesktop -r "reconstruction('$rawdata','$outdir','/data/tu_kuegler/loraks_scripts/alinadata/loraksConfig.json');exit" -sd /data/u_kuegler_software/git/image-reconstruction
